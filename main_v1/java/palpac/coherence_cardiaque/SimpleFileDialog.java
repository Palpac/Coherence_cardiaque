...
public class SimpleFileDialog
{
    ...
    private String m_sdcardDirectory_perso = "";
    ...
    public SimpleFileDialog(Context context, String file_select_type, SimpleFileDialogListener SimpleFileDialogListener)
    {
        ...
        m_sdcardDirectory_perso = Environment.getExternalStorageDirectory().getAbsolutePath() + "/Android/data/CoherenceCardiaque/"; // Ajout répertoire perso
    ...
    public void chooseFile_or_Dir()
    {
        ...
        //if (m_dir.equals(""))	chooseFile_or_Dir(m_sdcardDirectory); ////////////////////////////// Modif repertoire par defaut perso
        if (m_dir.equals(""))	chooseFile_or_Dir(m_sdcardDirectory_perso);
