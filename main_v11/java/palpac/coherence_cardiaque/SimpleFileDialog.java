...
public class SimpleFileDialog
{
    ...
    public SimpleFileDialog(Context context, String file_select_type, SimpleFileDialogListener SimpleFileDialogListener)
    {
        ...
        m_persoDirectory = m_sdcardDirectory;                                                       // Perso
        try                                                                                         // Perso
        {                                                                                           // Perso
            m_persoDirectory = new File(m_persoDirectory).getCanonicalPath();                       // Perso
        }                                                                                           // Perso
        catch (IOException ioe)                                                                     // Perso
        {                                                                                           // Perso
        }                                                                                           // Perso
    }
    ...
    public void chooseFile_or_Dir()
    {
        ...
        if (m_dir.equals(""))	chooseFile_or_Dir(m_persoDirectory);
    ...
    private List<String> getDirectories(String dir)
    {
        ...
        try
        {
            ...
            if (! m_dir.equals(m_persoDirectory) ) dirs.add("..");                                  // Perso
