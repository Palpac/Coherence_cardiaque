...
public class Settings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] spinner_items = new String[]{getString(R.string.spinner_title), "Original", "Bass_5mn", "Bass", "Clap", "Clave", "Flute", "Guitar", "Reggae", "Shake"}; //List of items for the spinner.
    ...
    private void maj_preferences() {
        ...
        sound = preferences.getString("Sound", "Bass_5mn"); // Lecture sound path
